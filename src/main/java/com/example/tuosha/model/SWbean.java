...
public class SWbean implements Serializable {
    ...
    public ArrayList<com.example.tuosha.model.ImsXuanMixloanBankEntity> getBankEntities() {
        return bankEntities;
    }

    public void setBankEntities(ArrayList<com.example.tuosha.model.ImsXuanMixloanBankEntity> bankEntities) {
